...
- (void) showBoardView:(id)sender
{
   ...
   [self.board release];
NSLog(@"10 board retain count: %i", [self.board retainCount]);
   ...
   switch(tag)
   {
      case 1:
         ...
         self.board.background           = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"CR.png" ofType:nil]];
